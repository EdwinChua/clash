CREATE DATABASE  IF NOT EXISTS `clashdash` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `clashdash`;
...
--
/*!50003 DROP PROCEDURE IF EXISTS `GetUserActivity` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetUserActivity`(IN playerId varchar(15))
BEGIN
...
-- Dump completed on 2018-05-11 17:45:28
